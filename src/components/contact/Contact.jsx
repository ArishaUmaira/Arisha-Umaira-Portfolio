      ...
      <div className="card-wrapper w-[90%] sm:w-[100%] mx-auto mt-5 flex items-center justify-center sm:flex-col">
        ...
        <div className="right flex-1">
          <form
            ...
            action="mailto:arishaa.umaira@gmail.com"
          >
            <input
            ...
            />
            <button
              className="bg-pink-500 w-full text-white font-semibold  p-2 rounded-lg flex items-center justify-center space-x-1"
              type="submit"
            >
              <span>Send</span>
              <RiSendPlaneFill/>
