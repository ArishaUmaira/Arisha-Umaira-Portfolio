      ...
      <nav className=" container m-auto flex items-center justify-between">
        ...
        >
          ...
          >
            ...
            {navItems.map((item) => (
              ...
              >
                <a
                  ...
                  href={`#${item.name}`}
                  className={`uppercase cursor-pointer text-black hover:text-pink-600 font-bold ${
            ...
            <a
              href=""
              className="bg-black text-[1rem] text-white px-8 py-2 rounded-lg font-bold hover:text-pink-400 md:m-5 md:block md:mx-auto md:w-fit lg:px-3"
            >
              HIRE ME
            </a>
          </ul>
