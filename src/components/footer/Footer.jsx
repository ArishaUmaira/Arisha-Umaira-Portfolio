...
const Footer = () => {
  return (
    <div id="works" className="mx-auto m-auto h-[300px] mt-16 sm:h-[250px]">
      <div className="bg-pink-400 h-full flex flex-col gap-8 items-center justify-between p-10 sm:p-7">
        <h2 
          data-aos="zoom-out"
        ...
        <div className="flex items-center justify-center gap-8 sm:gap-5">
          ...
          <a
            ...
            href="https://www.instagram.com/arisha.umaira/"
            target="_blank"
            rel="noopener noreferrer"
            className="box font-medium text-white flex items-center justify-center flex-col"
          >
        ...
        <div className="sm:text-[12px]">
          | Copyright &copy; <span>2024 Arisha Umaira </span> All rights reserved |
        </div>
      </div>
    </div>
  );
